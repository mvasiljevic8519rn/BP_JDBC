...
public class AppCore extends PublisherImplementation {
    ...
    public void setDataToTable(String fromTable) {
    	tableModel.setRows(this.database.setTable(fromTable));

        //Zasto ova linija moze da ostane zakomentarisana?
        this.notifySubscribers(new Notification(NotificationCode.DATA_UPDATED, this.getTableModel()));
    }
    public void updateDataToTable(String fromTable) {
    	tableModel.setRows(this.database.updateTable(fromTable));
